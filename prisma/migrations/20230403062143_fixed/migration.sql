...
CREATE TABLE "new_User" (
    ...
    "permLevelID" INTEGER NOT NULL DEFAULT 0,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "token" TEXT,
    CONSTRAINT "User_permLevelID_fkey" FOREIGN KEY ("permLevelID") REFERENCES "PermLevel" ("level") ON DELETE RESTRICT ON UPDATE CASCADE
);
